...
{
  this->lcd_display = hd44780_I2Cexp(DISPLAY_I2C_ADDRESS, CHARACTER_DISPLAY_RESOLUTION[0], CHARACTER_DISPLAY_RESOLUTION[1]); //, this->wire_interface);
  this->lcd_display.begin(CHARACTER_DISPLAY_RESOLUTION[0], CHARACTER_DISPLAY_RESOLUTION[1]);
